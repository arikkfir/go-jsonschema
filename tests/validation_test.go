...
import (
	...
	testExclusiveMaximum "github.com/arikkfir/go-jsonschema/tests/data/validation/exclusiveMaximum"
	testExclusiveMinimum "github.com/arikkfir/go-jsonschema/tests/data/validation/exclusiveMinimum"
	testMaxLength "github.com/arikkfir/go-jsonschema/tests/data/validation/maxLength"
	testMaximum "github.com/arikkfir/go-jsonschema/tests/data/validation/maximum"
	testMinLength "github.com/arikkfir/go-jsonschema/tests/data/validation/minLength"
	testMinimum "github.com/arikkfir/go-jsonschema/tests/data/validation/minimum"
	testMultipleOf "github.com/arikkfir/go-jsonschema/tests/data/validation/multipleOf"
	testPattern "github.com/arikkfir/go-jsonschema/tests/data/validation/pattern"
	testPrimitiveDefs "github.com/arikkfir/go-jsonschema/tests/data/validation/primitive_defs"
	testReadOnlyFields "github.com/arikkfir/go-jsonschema/tests/data/validation/readOnly"
	testReadOnlyAndRequiredFields "github.com/arikkfir/go-jsonschema/tests/data/validation/readOnlyAndRequired"
	testRequiredFields "github.com/arikkfir/go-jsonschema/tests/data/validation/requiredFields"
	"github.com/arikkfir/go-jsonschema/tests/helpers"
)
