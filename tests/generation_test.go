...
import (
	...
	"github.com/arikkfir/go-jsonschema/pkg/generator"
)
	...
	cfg.SchemaMappings = []generator.SchemaMapping{
		{
			...
			PackageName: "github.com/arikkfir/go-jsonschema/tests/helpers/schema",
			OutputName:  "schema.go",
		},
		{
			SchemaID:    "https://example.com/other",
			PackageName: "github.com/arikkfir/go-jsonschema/tests/data/crossPackage/other",
...
func TestCrossPackageNoOutput(t *testing.T) {
	...
	cfg.SchemaMappings = []generator.SchemaMapping{
		...
		{
			SchemaID:    "https://example.com/other",
			PackageName: "github.com/arikkfir/go-jsonschema/tests/helpers/other",
		},
	}
